function [lowest_error, best_transform_volume, best_resized_volume, best_params] = find_best_transformation(ref, shifted_image, t_min, t_max, t_step, r_min, r_max, r_step)
